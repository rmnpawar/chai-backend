...
const createPlaylist = asyncHandler(async (req, res) => {
    ...
    if (!playlist) {
        throw new ApiError(500, "Can't add playlist at the moment...");
    }
...
const getPlaylistById = asyncHandler(async (req, res) => {
    ...
    const playlistVideo = await Playlist.aggregateVideo([
        {
            $match: {
...
const addVideoToPlaylist = asyncHandler(async (req, res) => {
    ...
    if (!updatedPlaylist) {
        throw new ApiError(500, "Can't add video at the moment...");
    }
...
const updatePlaylist = asyncHandler(async (req, res) => {
    ...
    if (!updatedPlaylist) {
        throw new ApiError(500, "Can't update playlist at the moment...");
    }
